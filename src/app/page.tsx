...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-20">
      ...
      <div className="w-[90vw] md:w-[80vw] mx-auto space-y-20">
        {/* Dịch vụ */}
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-12 gap-4">
            {pageData.services.map((service) => (
              <div
                key={service.title}
                className="col-span-12 md:col-span-6 lg:col-span-4 border-3 rounded-md flex flex-row md:flex-col justify-center items-center text-center p-10 space-y-8 space-x-6 md:space-x-0 duration-150 hover:border-destructive hover:cursor-pointer hover:bg-destructive/5"
              >
                <Image
                  width={200}
                  height={200}
