...
const features = [
  {
    ...
    description:
      "Cung cấp nhiều loại hình bất động sản như nhà phố, căn hộ, đất nền, biệt thự… đáp ứng nhu cầu của nhiều đối tượng khách hàng.",
  },
  {
    icon: <Rotate3D />,
    title: "Quy trình giao dịch minh bạch",
    description:
      "Mọi thủ tục mua bán, chuyển nhượng đều rõ ràng, hợp pháp, đảm bảo quyền lợi cho khách hàng.",
  },
  {
    icon: <Scale />,
    title: "Hỗ trợ pháp lý tận tâm",
    description:
      "Tư vấn và hỗ trợ các vấn đề pháp lý liên quan đến bất động sản, giúp khách hàng yên tâm khi giao dịch.",
  },
  {
    icon: <Percent />,
    title: "Chính sách hậu mãi hấp dẫn",
    description:
      "Khách hàng được hưởng các chương trình ưu đãi, chăm sóc sau bán hàng, hỗ trợ giải quyết các vấn đề phát sinh.",
  },
] as const;

const questions = [
  {
    question: "Làm thế nào để chọn vị trí bất động sản phù hợp để đầu tư?",
    answer:
      "Bạn nên ưu tiên các khu vực có tiềm năng phát triển hạ tầng, gần trung tâm, tiện ích đầy đủ và có quy hoạch rõ ràng. Nghiên cứu kỹ thị trường và xu hướng phát triển của khu vực sẽ giúp bạn đầu tư hiệu quả hơn.",
  },
  {
    question: "Khi mua nhà đất cần lưu ý những gì về pháp lý?",
    answer:
      "Hãy kiểm tra kỹ giấy tờ pháp lý như sổ đỏ, giấy phép xây dựng, quy hoạch đất. Nên nhờ chuyên gia hoặc luật sư tư vấn để đảm bảo giao dịch hợp pháp và tránh rủi ro.",
  },
  {
    question: "Đầu tư bất động sản có rủi ro gì?",
    answer:
      "Một số rủi ro phổ biến gồm biến động giá, pháp lý không rõ ràng, dự án chậm tiến độ hoặc không đúng cam kết. Nên đa dạng hóa danh mục đầu tư và chọn đối tác uy tín.",
  },
  {
    question: "Có nên mua bất động sản trả góp không?",
    answer:
      " Mua trả góp giúp giảm áp lực tài chính ban đầu, nhưng bạn cần tính toán kỹ khả năng thanh toán hàng tháng và lãi suất để tránh phát sinh nợ xấu.",
  },
  {
    question: "Làm sao để tăng giá trị bất động sản đang sở hữu?",
    answer:
      "Nâng cấp, sửa chữa nhà cửa, cải thiện cảnh quan, bổ sung tiện ích hoặc chuyển đổi mục đích sử dụng là những cách giúp tăng giá trị bất động sản.",
  },
] as const;
  ...
  return (
    <React.Fragment>
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div className="text-center">
              <p className="text-xs font-semibold text-gray-500 uppercase mb-3 dark:text-neutral-200">
                Trần Thủy Land
              </p>
              <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-neutral-200">
                ...
                <ColourfulText text="sinh lời vượt trội" /> năm 2025
              </h1>
            </div>
            {/* Form */}
            <Form {...form}>
                ...
                <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border border-gray-200 rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20">
                  ...
                  <div className="whitespace-nowrap pt-2 sm:pt-0 grid sm:block">
                    <Button
                      type="submit"
                      disabled={isPending}
                      className="bg-gradient-to-r from-violet-600 to-indigo-600 h-12"
                    >
      ...
      <div className="flex justify-center max-w-screen">
        <iframe
          src="https://www.youtube.com/embed/245HExjnB6U"
          title="Cập nhật tiến độ dự án The Emerald 68 Tháng 3.2025"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerPolicy="strict-origin-when-cross-origin"
          allowFullScreen
          className="w-[90vw] md:w-1/2 aspect-video rounded-2xl"
        />
      </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-12">
          {features.map((feature) => (
            <div key={feature.title}>
              <div className="relative flex justify-center items-center size-12 bg-white rounded-xl before:absolute before:-inset-px before:-z-1 before:bg-linear-to-br before:from-blue-600 before:via-transparent before:to-violet-600 before:rounded-xl dark:bg-neutral-900 text-blue-500">
                {feature.icon}
              </div>
              <div className="mt-5">
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto mb-10 lg:mb-14">
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">
            Có thể bạn đang thắc mắc...
          </h2>
        </div>
        <div className="max-w-2xl mx-auto divide-y divide-gray-200 dark:divide-neutral-700">
          {questions.map((question) => (
            <div key={question.question} className="py-8 first:pt-0 last:pb-0">
      ...
      <div className="flex justify-center py-10">
        <button
          className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent text-white bg-gradient-to-r from-violet-600 to-indigo-600 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none animate-bounce hover:cursor-pointer"
