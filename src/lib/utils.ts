...
export const formatInfo = (
  ...
  return {
    ...
    facebookLogo: info.attributeValues["facebook-logo"].value[0]?.downloadLink,
    tiktok: info.attributeValues.tiktok.value,
    youtube: info.attributeValues.youtube.value,
    youtubeLogo: info.attributeValues["youtube-logo"].value[0]?.downloadLink,
    zalo: info.attributeValues.zalo.value,
    logo: info.attributeValues.logo.value[0]?.downloadLink,
    whiteLogo: info.attributeValues["white-logo"].value[0]?.downloadLink,
  };
};
